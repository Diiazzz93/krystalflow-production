...
function seedBulk(): BulkFormulaBOM[] {
  ...
  return [
    ...
    {
      id: "blk-ipa",
      productName: "Isopropyl Alcohol (IPA) Bulk Liquid",
      formulaSku: "BLK-IPA",
      outputUnit: "L",
      baseBatchSize: 1000,
      notes: "99.9% IPA. Flammable — store and handle in a ventilated area away from ignition sources.",
      updatedAt: now,
      ingredients: [
        { id: "i1", rawMaterialSku: "RAW-IPA", name: "Isopropyl Alcohol", quantity: 990, unit: "L", percentage: 99 },
        { id: "i2", rawMaterialSku: "RAW-WATER", name: "Deionised Water", quantity: 10, unit: "L", percentage: 1 },
      ],
    },
  ];
}
...
function seedFinished(): FinishedProductBOM[] {
  ...
  return [
    ...
    {
      id: "fin-ipa-500",
      productName: "IPA 500ml",
      productSku: "FIN-IPA-500",
      bulkFormulaId: "blk-ipa",
      containerSize: 500,
      containerUnit: "ml",
      liquidPerUnit: 0.5,
      bottleSku: "AQP-500",
      capSku: "CAP-28MM",
      labelSku: "LBL-IPA-500",
